...
class AppTextStyles {
  ...
  static TextStyle get greyTextStyle => TextStyle(
      fontSize: Constants.buttonFontSize20,
      color: AppColors.homeManagementTextColor);

  static TextStyle get buttonTextStyle => TextStyle(
        color: AppColors.lightOrange,
        fontSize: Constants.largeFontSize24,
  ...
  static TextStyle homeTextStyle(BuildContext context) {
    return TextStyle(
      color: AppColors.black,
      fontSize: DeviceSize.width(context) / 20,
      fontFamily: 'Poppins-Regular',
      fontWeight: FontWeight.w700,
    );
  }
  ...
  static TextStyle get blackRegular16Underline => TextStyle(
      color: AppColors.black,
  ...
  static TextStyle get normalFont17 => TextStyle(
      color: AppColors.black,
      fontSize: Constants.fontSize17,
      fontFamily: 'Poppins-Light',
      fontWeight: FontWeight.w400);

  static TextStyle get normalLightFont14 => TextStyle(
      color: AppColors.black,
      fontSize: Constants.fontSize14,
      fontFamily: 'Poppins-Light',
      fontWeight: FontWeight.w400);

  static TextStyle get normalBoldFont14 => TextStyle(
      color: AppColors.black,
      fontSize: Constants.fontSize14,
  ...
  static TextStyle normalLight(BuildContext context) {
    return TextStyle(
        color: AppColors.black,
        fontSize: DeviceSize.width(context) / 30,
        fontFamily: 'Poppins-Light',
  ...
  static TextStyle get headingTextItalic30 => TextStyle(
        color: AppColors.white,
        fontSize: 40,
  ...
  static TextStyle get headingTextDarkItalic30 => TextStyle(
  ...
  static TextStyle get textExtraLargeTextStyle => TextStyle(
        color: AppColors.lightOrange,
        fontSize: Constants.extraLargeFontSize30,
        fontFamily: 'Poppins-Bold',
        fontWeight: FontWeight.w700,
      );

  static TextStyle get textLargeTextStyle => TextStyle(
        color: AppColors.black,
        fontSize: Constants.largeFontSize24,
        fontFamily: 'Poppins-Regular',
        fontWeight: FontWeight.w700,
